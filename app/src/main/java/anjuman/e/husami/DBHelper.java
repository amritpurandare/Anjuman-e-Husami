...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static String DATABASE_NAME = "kasim.db";
...
//    }
    ...
    public Cursor select(String table_name, String[] columns, String selections, String[] selectionArgs, String groupBy, String having, String orderBy) {
